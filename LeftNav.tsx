...
export type NavLinkItem = {
   ...
   * Renders a plain `<a target="_blank"
...
/**
 * Segment-aware active check. A plain `startsWith` marks a route like `/orders/cost-rules`
 * active while you are on a similarly-prefixed sibling route (e.g. `/orders-quotes`), because
 * one string is a prefix of the other — match whole path segments instead.
 *
